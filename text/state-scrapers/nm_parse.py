...
async def main():
    df = pd.read_csv("text/state-scrapers/nm_bill_text_files.csv")

    text_dir = Path("/Users/josephloffredo/MIT Dropbox/Joseph Loffredo/election_bill_text/data/new_mexico")
